...
public class SecretOutpot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //
        setTitle("Secret List");

        //
        ListView listView=(ListView)findViewById(R.id.ListView);
        ArrayList<String> arrayList=new ArrayList<String>();
       SecretDatabaseOpenHelper sqLiteDatabase =MainActivity.secretDatabaseOpenHelper;
        ...
        try {
            ...
            cursor = myDAtabase.rawQuery("SELECT * FROM secret", null);
            cursor.moveToFirst();
            while(cursor!=null){
        ...
        if(arrayList.isEmpty()){
            Toast.makeText(SecretOutpot.this, "You don't have anything in your List", Toast.LENGTH_SHORT).show();
        }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Cursor c = myDAtabase.rawQuery("SELECT * FROM secret WHERE Message =?", new String[]{wanted});
                c.moveToFirst();
                String Current_Date = c.getString(c.getColumnIndex("Date"));
//Toasting date

                myDAtabase.delete(" secret","Message = ?",new String[]{wanted});
                newArray.remove(position);
                arrayAdapter.notifyDataSetChanged();

                Toast.makeText(SecretOutpot.this, "Selected item has been successfully deleted--DATE: "+String.valueOf(Current_Date), Toast.LENGTH_SHORT).show();
